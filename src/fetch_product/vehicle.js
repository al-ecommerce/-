...
const handleDes = (el) => {
    ...
    document.getElementById("allproduct").value="https://faint-dandelion-lilac.glitch.me/vehicle";
...
var path="https://faint-dandelion-lilac.glitch.me/vehicle";
                    ...
                    <div className="product__item">
                        <div className="product__item__pic set-bg" style={{background: `url(${el.image})` , backgroundRepeat:"no-repeat",backgroundSize:"cover"}}>
                            ...
                            <ul className="product__hover">
                                <li><a title="description" onClick={()=>handleDes(el)}><i className="fa fa-id-card-o"></i></a></li>
