...
const ListingFormModal = ({ isOpen, onClose, type, categories, editItem, uid, userDoc, onSaved }) => {
  ...
  const defaultForm = {
    ...
    pricingType:    "fixed",   // NEW: flexible pricing type

    deliveryMethod: "both",    // NEW: pickup / delivery / both
  ...
  useEffect(() => {
    ...
    if (editItem) {
      ...
      setForm({
        ...
        deliveryMethod: editItem.deliveryMethod      || "both",
  ...
  // Dynamic price label based on pricing type
  ...
  // Dynamic price placeholder based on pricing type
  ...
  const showDeliveryFee = form.deliveryMethod === "delivery" || form.deliveryMethod === "both";
    ...
    >
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
        ...
        {form.pricingType !== "free" ? (
          ...
          /* Empty cell — keeps Category on its own row below */
      ...
      {/* ── Delivery Fee (only when delivery is applicable) ────────────── */}
